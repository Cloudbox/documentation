...
9. Application Setup
   1. [NZBGet]()
   2. [ruTorrent](../install-cloudbox/09-application-setup/install-rutorrent.md)
   3. [NZBHydra2](../install-cloudbox/09-application-setup/install-nzbhydra2.md)
   4. [Jackett](../install-cloudbox/09-application-setup/install-jackett.md)
   5. [Plex Media Server]()
   6. [Plex Autoscan]()
   7. [Sonarr](../install-cloudbox/09-application-setup/install-sonarr.md)
   8. [Radarr](../install-cloudbox/09-application-setup/install-radarr.md)
   9. [Lidarr](../install-cloudbox/09-application-setup/install-lidarr.md)
   10. \[PlexPy \(Tautulli\)\]\(Install-PlexPy-\(Tautulli\).md\)
   11. [Ombi]()
   12. [Portainer](../install-cloudbox/09-application-setup/install-portainer.md)
   13. [Organizr](../install-cloudbox/09-application-setup/install-organizr.md)
...
9. Application Setup 1. [NZBGet]() 1. [ruTorrent](../install-cloudbox/09-application-setup/install-rutorrent.md) 1. [NZBHydra2](../install-cloudbox/09-application-setup/install-nzbhydra2.md) 1. [Jackett](../install-cloudbox/09-application-setup/install-jackett.md) 1. [Sonarr](../install-cloudbox/09-application-setup/install-sonarr.md) 1. [Radarr](../install-cloudbox/09-application-setup/install-radarr.md) 1. [Lidarr](../install-cloudbox/09-application-setup/install-lidarr.md) 1. [Portainer](../install-cloudbox/09-application-setup/install-portainer.md) 1. [Organizr](../install-cloudbox/09-application-setup/install-organizr.md)
10. [Overview]()
11. [Dependencies]()
    * \[Master Branch \(default\)\]\(Install-Dependencies-\(Master-Branch\).md\)
    * \[Develop Branch\]\(Install-Dependencies-\(Develop-Branch\).md\)
